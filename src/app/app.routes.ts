...
import { ObjectivesComponent } from './qsamax/objectives/objectives.component';
import { ObjectiveGoalComponent } from './qsamax/objectives/objective-goal/objective-goal.component';
import { WelcomeComponent } from './qsamax/welcome/welcome.component';
import { NonConformityProductComponent } from './qsamax/non-conformity/non-conformity-product/non-conformity-product.component';
...
export const routes: Routes = [
...

    {
        ...
        component: EcommercePageComponent,
        children: [
            {path: '', component: NonConformityProductComponent},
            {path: 'non-conformity-product', component: NonConformityProductComponent},
            {
                path: 'non-conformity-product/:id', // Ruta para el detalle, :id es el parámetro
                component: NonConformityProductDetailComponent
              },
...

    {
        ...
        component: WelcomeComponent // Si WelcomeComponent es standalone y no lazy loaded
        // O si prefieres lazy loading para el componente de bienvenida:
